...
global.ownername = process.env.OWNER_NAME === undefined ? "Dileepa" : process.env.OWNER_NAME
let fake = process.env.OWNER_NUMBER === undefined ? '94705674697' : process.env.OWNER_NUMBER
global.owner = process.env.OWNER === undefined ? '94705674697' : process.env.OWNER
global.ownernumber = process.env.OWNER_NUMBER === undefined ? '94705674697' : process.env.OWNER_NUMBER
global.premium = process.env.PREMIUM === undefined ? '94705674697' : process.env.PREMIUM
global.anticall = process.env.ANTICALL === undefined ? 'false' : process.env.ANTICALL
global.packname = process.env.PACK_NAME === undefined ? 'dileepa-MD' : process.env.PACK_NAME
global.author = process.env.STICKER_AUTHOR_NAME === undefined ? 'Dileepa' : process.env.STICKER_AUTHOR_NAME
